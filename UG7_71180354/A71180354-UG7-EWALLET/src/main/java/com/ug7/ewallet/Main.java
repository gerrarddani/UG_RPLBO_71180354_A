...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71180354 = new User("Bonifacius Dani Yudha", "bonifacius.dani@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71180354 = new GoPay(U_71180354);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71180354.getUser().getNama()+"] - ");
        E_71180354.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71180354.getUser().getNama()+"] - ");
        E_71180354.topup(50000);
        System.out.print("["+E_71180354.getUser().getNama()+"] - ");
        E_71180354.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71180354, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71180354.getUser().getNama()+"] - ");
        E_71180354.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71180354.getUser().getNama()+"] - ");
        E_71180354.withdraw(1100);
